  ...
  return (
    <>
      ...
      <main className="pt-16 sm:pt-28">
        ...
        {/* ── Collection header ───────────────────────────────────────── */}
        <section className="px-4 sm:px-6 pb-8 sm:pb-14 border-b border-border">
          <div className="mx-auto max-w-7xl">
            {/* Breadcrumb */}
            <ScrollReveal direction="up" delay={0}>
              <div className="flex items-center gap-2 text-xs tracking-widest uppercase text-muted-foreground mb-5 sm:mb-8">
            ...
            <div className="grid md:grid-cols-12 gap-4 sm:gap-8 items-end">
              <ScrollReveal direction="up" delay={0.05} className="md:col-span-7">
                <p className="text-xs tracking-[0.3em] uppercase text-secondary mb-2 sm:mb-4">{collection.category} · {collection.year}</p>
                <h1 className="font-heading text-4xl sm:text-6xl md:text-8xl font-light leading-none tracking-tight">
                  {collection.title}
                </h1>
              </ScrollReveal>
        ...
        <div className="w-full h-[45vh] sm:h-[60vh] md:h-[75vh] relative overflow-hidden">
          <Image
        ...
        {/* ── Intro text ──────────────────────────────────────────────── */}
        <section className="py-8 sm:py-12 md:py-(--spacing-section-md) px-4 sm:px-6 border-b border-border">
          <div className="mx-auto max-w-7xl grid md:grid-cols-12">
            <ScrollReveal direction="up" delay={0} className="md:col-span-7 md:col-start-4">
              <p className="font-heading text-xl sm:text-2xl md:text-3xl font-light italic text-muted-foreground leading-relaxed">
                {collection.intro}
              </p>
            </ScrollReveal>
          </div>
        ...
        {/* ── Print enquiry CTA ───────────────────────────────────────── */}
        <section className="py-8 sm:py-12 md:py-(--spacing-section-md) px-4 sm:px-6 bg-muted border-t border-border">
          <div className="mx-auto max-w-7xl grid md:grid-cols-12 gap-6 sm:gap-8 items-center">
            <ScrollReveal direction="up" delay={0} className="md:col-span-6">
              <p className="text-xs tracking-[0.3em] uppercase text-secondary mb-2 sm:mb-4">Limited editions</p>
              ...
              <p className="mt-3 sm:mt-5 text-sm font-light text-muted-foreground leading-relaxed max-w-sm">
        ...
        <nav className="border-t border-border grid grid-cols-2">
          {prev ? (
            <Link
              href={`/work/${prev.slug}`}
              className="group flex flex-col gap-1.5 sm:gap-2 p-5 sm:p-8 md:p-12 border-r border-border hover:bg-muted transition-colors"
            >
              ...
              <span className="font-heading text-base sm:text-xl md:text-2xl font-light">{prev.title}</span>
          ...
          {next ? (
            <Link
              href={`/work/${next.slug}`}
              className="group flex flex-col gap-1.5 sm:gap-2 p-5 sm:p-8 md:p-12 text-right hover:bg-muted transition-colors"
            >
              ...
              <span className="font-heading text-base sm:text-xl md:text-2xl font-light">{next.title}</span>
